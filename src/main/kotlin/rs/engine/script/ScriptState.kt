...
open class ScriptState(
    ...
    var _activeLoc: Loc? = null
    var _activeLoc2: Loc? = null

    var _activeObj: Obj? = null
    var _activeObj2: Obj? = null
    ...
    var locIterator = ArrayList<Loc>()
    var objIterator = ArrayList<Obj>()
